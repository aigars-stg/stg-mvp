    ...
    return NextResponse.json({
      ...
      order: {
        ...
        payment: {
          ...
          everypay_payment_state: order.everypay_payment_state,
          ...
          wallet_credited_at: order.wallet_credited_at,
        },
        ...
        dispute_photo_urls: order.dispute_photo_urls,
        dispute_status: order.dispute_status,
        dispute_seller_deadline: order.dispute_seller_deadline,
        dispute_seller_response: order.dispute_seller_response,
        dispute_seller_photo_urls: order.dispute_seller_photo_urls,
        dispute_seller_responded_at: order.dispute_seller_responded_at,
        dispute_resolved_at: order.dispute_resolved_at,
        dispute_resolution: order.dispute_resolution,
        dispute_resolution_note: order.dispute_resolution_note,
        dispute_resolved_by: order.dispute_resolved_by,
        timestamps: {
