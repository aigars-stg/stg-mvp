...
// Note: Ensure the path to lib/legal is correct relative to this file
// app/seller/terms/page.tsx -> ../../../lib/legal

export async function generateMetadata(): Promise<Metadata> {
  const { frontmatter } = getLegalDocument('seller-terms');
  return {
...
export default function SellerTermsPage() {
  const { content, frontmatter } = getLegalDocument('seller-terms');
