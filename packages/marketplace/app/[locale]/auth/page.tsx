      ...
      <>
        ...
        <Card padding="lg">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={tExistingUser('passwordPlaceholder')}
                  required
                  disabled={loading}
                ...
                <button
                  ...
                  tabIndex={-1}
                  aria-label={showPassword ? tExistingUser('hidePassword') : tExistingUser('showPassword')}
                >
                  {showPassword ? (
          ...
          <Button
            ...
            loading={loading}
          >
            {loading ? tExistingUser('sending') : tExistingUser('sendMagicLinkInstead')}
          </Button>
            ...
            <div className="mt-3 space-y-2">
              {isGoogleUser && (
                ...
                >
                  ...
                  {tExistingUser('signInWithGoogle')}
                </Button>
              )}
            </div>
          )}
