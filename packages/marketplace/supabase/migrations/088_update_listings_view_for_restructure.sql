-- Migration: Update listings_with_details view for new listing type model
-- Description: Adds transaction_method and pricing_format columns to the view
-- Depends on: 087_restructure_listing_types.sql
...
SELECT
  ...
  -- NEW: Separate transaction method and pricing format
  l.transaction_method,
  l.pricing_format,

  -- DEPRECATED: Keep listing_type for backwards compatibility during transition
  l.listing_type,
...
Supports all combinations: transaction_method (contact_seller, instant_buy) x pricing_format (fixed_price, auction).
