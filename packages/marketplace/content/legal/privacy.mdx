...
### 2.7 Technical Data
We use a small number of cookies to make the platform work. For full details on the data collected and your choices, please see our [Cookie Policy](/legal?section=cookies).
...
For current reporting thresholds, plain-language examples, and a detailed breakdown of what data is reported, see our [DAC7 Tax Reporting Guide](/help?section=dac7).
