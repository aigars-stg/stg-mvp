...
description: "How Second Turn Games uses cookies and similar technologies."
---
...
We respect the "Do Not Track" browser setting. If enabled, we will not set analytics cookies even if you previously consented.
...
| Authentication | 7 days (then you will need to sign in again) |
| Preferences | 1 year |
