...
**Document**: Privacy Policy (for `/legal?section=privacy`)
**Status**: Draft v2
...
│ 📋 **In plain terms**                                           │
│                                                                 │
│ We need your email to send you sign-in links and order updates. │
│ Your name and country appear on your profile so other users     │
...
│ 📋 **In plain terms**                                           │
│                                                                 │
│ To sell, you need to be 18+ and verify your identity through    │
│ Stripe. This is required by payment regulations and EU tax      │
│ laws. Stripe handles the verification — we don't see your ID    │
│ documents or full bank details.                                 │
└─────────────────────────────────────────────────────────────────┘
...
│ 📋 **In plain terms**                                           │
│                                                                 │
│ Don't share sensitive personal information (like your home      │
│ address or phone number) in messages until you're ready to      │
│ complete a transaction. We can't control what happens to info   │
...
Under EU Council Directive 2021/514 (DAC7), we are legally required to report seller information — but only for sellers who exceed certain thresholds. If you're occasionally selling games from your personal collection, you're almost certainly not affected.

┌─────────────────────────────────────────────────────────────────┐
│ 📋 **In plain terms**                                           │
│                                                                 │
│ This applies to all EU platforms — eBay, Vinted, Etsy, not just │
│ us. If you already pay taxes on your income honestly, this      │
│ changes nothing for you. As Latvia's tax authority (VID) puts   │
│ it: honest taxpayers "will not feel it in their daily lives."   │
└─────────────────────────────────────────────────────────────────┘
...
We'll notify you when you reach approximately 80% of either threshold:
- **24 sales** or **€1,600** in proceeds

At this point, we'll ask for your Tax Identification Number (TIN) so we're prepared if you cross the threshold.
...
**Reporting ≠ new taxes.** DAC7 is about information sharing, not creating tax obligations. If you already declare your income correctly, nothing changes. If you're selling personal items occasionally (not running a business), you likely have no tax obligation anyway.
...
[Learn more about DAC7 →](/help/dac7)
...
│ 📋 **In plain terms**                                           │
│                                                                 │
│ We keep your account data until you delete it. Transaction      │
│ records stick around for 7 years because tax law requires it —  │
...
│ 📋 **In plain terms**                                           │
│                                                                 │
│ You can't delete transaction records or DAC7 reported data —    │
│ we're legally required to keep those for 7 years. Everything    │
│ else gets deleted when you delete your account.                 │
└─────────────────────────────────────────────────────────────────┘
...
While we implement industry-standard security measures, no system is 100% secure. Keep your email account secure, as it's used for sign-in.
...
# Change Log (from original privacy.md)

| Section | Change |
|---------|--------|
| Throughout | Added 7 plain-language callout boxes |
| 2.1 | Removed password reference; updated for magic link auth |
| 2.2 | Added callout explaining 18+ requirement for sellers |
| 4 | Added **Resend** (email delivery) — was missing |
| 4 | Added **MapLibre/Carto** (maps) — was missing |
| 5.1 | Added 80% warning threshold details (24 sales / €1,600) |
| 6 | Simplified cookies section; references separate Cookie Policy |
| 11 | **FIXED: Age from "under 18" to "16+ to use, 18+ to sell"** |
| 13 | Added info@ email alongside privacy@ |

# Implementation Notes

## Plain Terms Box Locations (7 total)

1. Section 2.1 — Why we need email/name/country
2. Section 2.2 — Seller verification and Stripe
3. Section 2.5 — Warning about sharing info in messages
4. Section 5 — DAC7 threshold explanation
5. Section 7 — Data retention explanation
6. Section 8 — What you can't delete (transaction records)

## Cross-References to Other Hub Sections

- Cookie Policy → `/legal?section=cookies`
- Seller Agreement → `/legal?section=seller`

## Translation Notes

Legal text should be professionally translated. Plain-language boxes should be transcreated for each language.

Key terms to keep consistent:
- "magic link" — authentication method
- "30 sales" / "€2,000" — DAC7 thresholds
- "7 years" — retention period
- "30 days" — response time for GDPR requests
